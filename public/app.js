...
const state = {
  ...
  navOpen: false,
  settings: { storeName: 'Godwyn Stores', tagline: 'Quality goods, delivered across Zambia.', currency: 'ZMW', whatsappNumber: '0760565047', supportPhone: '0760565047', aboutText: '', storeAddress: '', contactEmail: '' },
  cartOpen: false,
  toast: null,
...
async function submitOrder(formEl) {
  ...
  try {
    const result = await api('/api/orders', {
      method: 'POST',
      body: { items, customerName, phone, altPhone, town, province, address, deliveryDate, deliveryWindow, notes },
    });
    state.cart = {};
