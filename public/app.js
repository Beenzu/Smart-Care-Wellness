...
function renderStore(app) {
  ...
  app.innerHTML = `
    ...
    <div class="wrap">
      ...
      <section class="store-hero" aria-label="Godwyn Stores introduction">
        <div class="store-hero-copy">
          <div class="eyebrow">QUALITY PRODUCTS · SIMPLE SHOPPING</div>
          <h1>Quality products.<br><span>Simple shopping.</span></h1>
          <p>Discover useful products at great value and order directly from Godwyn Stores. Clear product information, easy ordering and dependable delivery across Zambia.</p>
          <div class="hero-actions">
            <button class="btn hero-primary" onclick="document.getElementById('store-products')?.scrollIntoView({behavior:'smooth',block:'start'})">Shop Products</button>
            <button class="btn hero-secondary" onclick="state.view='services'; render(); window.scrollTo({top:0,left:0,behavior:'smooth'});">How can we help?</button>
          </div>
        </div>
        <div class="store-hero-art" aria-hidden="true">
          ...
          <div class="hero-card">
            <span>GODWYN STORES</span>
            <strong>Shop smart.<br>Order simply.</strong>
            <small>Quality goods, delivered across Zambia.</small>
          </div>
        </div>
      </section>

      <div id="store-products" class="filter-bar">
