window.addEventListener('error', (event) => {
  ...
  if (app && !app.innerHTML.trim()) {
    app.innerHTML = `<div class="wrap"><div class="panel"><h2>Smart Care Wellness</h2><p>There was a problem loading the storefront.</p><p class="muted">Please refresh the page. If the problem continues, contact support.</p></div></div>`;
  }
});
...
const state = {
  ...
  navOpen: false,
  settings: { storeName: 'Smart Care Wellness', tagline: 'Quality goods, delivered across Zambia.', currency: 'ZMW', whatsappNumber: '260779173957', supportPhone: '+260779173957', aboutText: '', storeAddress: '', contactEmail: '', facebookUrl: '', instagramUrl: '', tiktokUrl: '' },
  cartOpen: false,
...
async function submitOrder(formEl) {
  ...
  if (!Number.isInteger(availableStock) || availableStock < 0) {
    showToast('This product has an invalid stock value. Please contact Smart Care Wellness.');
    return;
  }
        ...
        <div class="checkout-layout">
          ...
          <div class="panel">
            ...
            <form id="checkout-form" onsubmit="event.preventDefault(); submitOrder(this);">
              ...
              <label class="agreement-check"><input type="checkbox" name="agreement" required> <span>I have read and agree to the <a href="#" onclick="event.preventDefault(); state.view='policy'; render();">Smart Care Wellness Policy & Agreement</a>.</span></label>
  ...
  app.innerHTML = `
    ...
    <div class="wrap">
      ...
      <div class="panel policy-page">
        <h1>Smart Care Wellness Policy & Agreement</h1>
        ...
        <h3>1. Ordering</h3>
        <p>When you click <strong>Order Now</strong>, you select the product quantity and provide your contact and delivery information. Submitting an order is a request to purchase the selected product; Smart Care Wellness will contact you to confirm the order and delivery details.</p>
        ...
        <p>Orders are confirmed by phone. If we cannot reach you or the details provided are incomplete, delivery may be delayed or the order may not be processed. Customers should contact Smart Care Wellness as soon as possible if they need to cancel or change an order before delivery.</p>

        <h3>6. Returns, exchanges and damaged items</h3>
        <p>Customers should inspect products at delivery and report any visible damage, missing item or incorrect product promptly. Returns or exchanges depend on the condition of the product and the circumstances of the issue. Contact Smart Care Wellness before returning an item so that the appropriate resolution can be agreed.</p>
        ...
        <h3>9. Agreement</h3>
        <p>By checking the agreement box during checkout and placing an order, you confirm that you have read and accepted this Policy & Agreement. Smart Care Wellness may update these terms when necessary; the version displayed on the store at the time of your order applies to that order.</p>
    ...
    <div class="panel">
      ...
      <div class="about-copy">
        ${state.settings.aboutText
          ...
          : `<p>Smart Care Wellness is a customer-focused online shop bringing together practical health products for <strong>Men and Women</strong>. We make shopping simpler by giving customers a convenient way to browse available products, place an order and arrange reliable delivery across Zambia.</p>
